       ...
       <div class="content">
            <div class="container">
                <div class="row">
                    ...
                    <legend class="shadow"><i class="fa fa-user"></i>Personal Information</legend>
                         <div id="edit">
                    ...
                    <legend class="shadow"><i class="fa fa-users"></i>Family Data</legend>
                         <div id="edit">
                    ...
                    <legend class="shadow"><i class="fa fa-ambulance"></i>Emergency Details</legend>
                         <div id="edit">
                    ...
                    <legend class="shadow"><i class="fa fa-building-o"></i> Company Information</legend>
                         <div id="edit">
