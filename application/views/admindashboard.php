                          ...
                          <ul class="nav navbar-nav">
                            <li class="dropdown">
                              ...
                              <ul class="dropdown-menu" id="show-logout">
                                ...
                                <li><a href="changepassword">Change password <i class="fa fa-key" style="position: absolute; right: 40px; top: 10px;" aria-hidden="true"></i></a></li>
                                <li class="divider"></li>
                    
                                <li><a href="logout">Log Out <i class="fa fa-sign-out" style="position: absolute; right: 40px; top: 40px;"></i></a></li>
                              </ul>
                            </li>
                          </ul>
                    </div>
