...
<head>
    ...
    <script src="<?php echo base_url()?>assets/js/progressbar.js/dist/progressbar.js"></script>
    <script src="<?php echo base_url()?>assets/js/progressbar.js/dist/progressbar.min.js"></script>
